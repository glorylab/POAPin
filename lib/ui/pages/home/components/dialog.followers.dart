...
class FollowersDialog extends StatelessWidget {
  const FollowersDialog({Key? key, required this.followers}) : super(key: key);

  final List<Map<String, String>> followers;

  Widget _buildFollwerItem(Map<String, String> follower) {
    return Card(
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          ...followers.map((f) => _buildFollwerItem(f)),
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          const SizedBox(height: 72),
          Text(
            'You\'ll gain followers if your friends save your collection on the official POAP app! ',
            ...
            child: Stack(
              children: [
                GetBuilder<SocialCardController>(builder: (c) {
                  if (c.followersWithENS.isNotEmpty) {
